      ...
      <div class="listCard mt-3 border border-dark col-12 col-md-5 mx-auto">
        <a href="detail.php?index=<?php echo $value->getId(); ?>">
          <div class="col-12 p-0 m-0">
            ...
            <p class="cardPrice text-center pb-2 mb-0 mt-2 blackText">Doors: <?php echo $value->getDoors();?></p>
          </div>
        </a>
        <form  class="mb-2 text-center" action="delete_index.php?index=<?php echo $value->getId(); ?>" method="post">
